            ...
            <tr v-for="(item, index) of items">
              ...
              <td>
                <a :title="item.src" href="#" @click="select(index+1,item)" data-toggle="modal" data-target="#viewModal">
                  <span data-feather="play"></span> {{ item.src.slice(0,50) }}... 
                </a>
              </td>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div style="background:#000;height:400px">
              <iframe :src="viewData.src" width="798px" height="400px" frameborder="0" allowfullscreen></iframe>
            </div>
...
module.exports = {
  ...
  methods:{
    fetchData(){
      progress.start()
      this.$store.dispatch("getCollection",{collection:"videos"})
      .then(ret=>{
